...
1. Go to the [Security tab](https://github.com/JackPlowman/screenshot_mailinator_email/security) of the repository.
...
We will notify users about security updates through the repository's release notes and the [Security Advisories](https://github.com/JackPlowman/screenshot_mailinator_email/security/advisories) section.
